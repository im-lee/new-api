...
func TestBuildAliDeepseekStreamInspectionRetryErrorFromSSE(t *testing.T) {
	body := "data: {\"error\":{\"message\":\"data inspection failed\",\"type\":\"data_inspection_failed\",\"code\":\"data_inspection_failed\"}}\n\ndata: [DONE]\n\n"
